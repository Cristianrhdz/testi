...
banner_start() {
  ...
  echo "**************************************************************"
  echo "                                                              "
  echo "      ,;;;;;,       Hecho por Cristian Tu Papi Rincon         "
  echo "     ;;;;;;;;;.      (beta $VERSION)                          "
  echo "   ;;;;;;;;;;;;;                                              "
  echo "  ;;;;  ;;;  ;;;;   <--contribuciones y comentarios al mail - "
  echo "  ;;;;  -;;;      -------Clovercloveruno@gmail.com------>     "
  echo "														      "
  echo " _____                    _____          					  "
	echo "         /\    \                  /\    \         		  "
	echo "        /::\    \                /::\    \    			  "    
...
banner_end() {
  ...
  echo "         'systemctl start|stop heplify | systemctl start heplify-server.service'"
  echo
